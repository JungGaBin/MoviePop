...
train_x_batch, train_y_batch = tf.train.batch([xy[0:-1], xy[-1:]], batch_size=300)
...
W5 = tf.get_variable("W5", shape=[100, 1], initializer=tf.contrib.layers.xavier_initializer())
